<x-layout>
  <div class="flex gap-2 items-center">
    ...
    <h1 class="dark:text-white text-2xl font-bold">Add Product</h1>
  </div>
  <section class="mt-5">
    <form method="POST" action="{{ route('productStore') }}" enctype="multipart/form-data">
      ...
      <section class="form-grid-3 mb-4">
        ...
        <x-textbox id="price" type="number" label="Price" name="price" value="{{ old('price') }}" error="{{ $errors->first('price') }}" />
